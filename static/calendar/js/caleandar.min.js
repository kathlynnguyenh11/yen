function createCalendar(e,t,a){
    function n(){
        ...
        for (var l=0; l<s.length-3;l++){
            ...
            if (0>d?d+=12:d>11&&(d-=12),0==l)
                ...
                i.addEventListener("click",function(){"function"==typeof e.Options.ModelChange?e.Model=e.Options.ModelChange():e.Model=e.Options.ModelChange,createCalendar(e,t,-1)}),
        ...
        if (l.className+=" today",l.innerHTML=s[e.Selected.Month]+", "+e.Selected.Year,a.appendChild(l),e.Options.NavShow&&!e.Options.NavVertical){
            ...
            i.className+=" cld-fwd cld-nav",
            i.addEventListener("click",function(){createCalendar(e,t,1)}),
    ...
    function i(){
        ...
        for (var t = ["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],a=0;a<t.length;a++){
            ...
            n.innerHTML=t[a],e.appendChild(n)
        }
        r.appendChild(e)
    }
